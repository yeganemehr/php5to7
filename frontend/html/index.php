...
<div class="comparison-container">
	<div class="page-container">
		...
		<p>کدتون + خطایی که دریافت میکنید رو از <a href="https://blog.jeyserver.com/php7-migration">این صفحه</a> ارسال کنید و ما سعی میکنیم تا در اولین فرصت براتون مشکل رو توضیح بدیم و درصورت امکان با کمک هم حلش کنیم.</p>
