...
<div class="comparison-container">
	<div class="page-container">
		...
		<p><a href="https://blog.jeyserver.com/php7-migration">داستانش مفصله!</a></p>

		<h3>من از ابزارتون استفاده کردم ولی باز هم خطا میگیرم، کمکم کنید؟</h3>
		<p>کدتون + خطایی که دریافت میکنید رو از <a href="https://github.com/yeganemehr/php5to7/issues/new">این صفحه</a> ارسال کنید و ما سعی میکنیم تا در اولین فرصت براتون مشکل رو توضیح بدیم و درصورت امکان با کمک هم حلش کنیم.</p>
